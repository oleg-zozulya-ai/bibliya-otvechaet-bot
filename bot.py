...
# Не показываем подробные HTTP-запросы Telegram в логах Render.
# Это также не позволяет токену появляться в URL внутри логов.
logging.getLogger("httpx").setLevel(logging.WARNING)
logging.getLogger("httpcore").setLevel(logging.WARNING)


# --------------------------------------------------
# НАСТРОЙКИ RENDER / TELEGRAM
# --------------------------------------------------

# Получаем токен только из Environment Variables Render.
# split() удаляет пробелы, Enter, \n, \r, табуляцию
# и другие случайно попавшие невидимые символы.
...
# Публичный адрес Web Service Render.
...
def main():
    ...
    # Здесь выводится только адрес нашего Render,
    # Telegram-токен в лог не записывается.
    logger.info(
        "Запуск webhook: %s",
        webhook_url,
    )
